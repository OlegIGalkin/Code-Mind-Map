  ...
  const c = (r) => {
    ...
    if (r.clipboardData) {
      const a = Ee(e.currentNodes).map((h) => h.nodeObj), d = Le({
        magic: Oe,
        data: a
      }), u = a.map((u) => u.topic || "").join(`
`);
      return r.clipboardData.setData("text/plain", d), u !== null && u.trim().length > 0 ? r.clipboardData.setData("text/plain", u) : r.clipboardData.setData("text/plain", d), r.preventDefault(), !0;
    }
    return !1;
  };
...
function An(e) {
  ...
  const d = 500, h = 10, u = () => {
    ...
    f.key === "Space" && (e.spacePressed = !0, e.container.classList.add("space-pressed"));
  }, x = (f) => {
    f.key === "Space" && (e.spacePressed = !1, e.container.classList.remove("space-pressed"));
  }, L = (f) => {
